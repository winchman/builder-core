...
type UnitConfig struct {
	...
	ContainerGlobals *ContainerSection   `toml:"container_globals" json:"container_globals" yaml:"container_globals,omitempty"`
}
...
type ContainerSection struct {
	Name       string   `toml:"name" json:"name" yaml:"name,omitempty"`
	Dockerfile string   `toml:"Dockerfile" json:"Dockerfile" yaml:"Dockerfile,omitempty"`
	Registry   string   `toml:"registry" json:"registry" yaml:"registry,omitempty"`
	Project    string   `toml:"project" json:"project" yaml:"project,omitempty"`
	Tags       []string `toml:"tags" json:"tags" yaml:"tags,omitempty"`
	SkipPush   bool     `toml:"skip_push" json:"skip_push" yaml:"skip_push"`
	CfgUn      string   `toml:"dockercfg_un" json:"dockercfg_un" yaml:"dockercfg_un,omitempty"`
	CfgPass    string   `toml:"dockercfg_pass" json:"dockercfg_pass" yaml:"dockercfg_pass,omitempty"`
	CfgEmail   string   `toml:"dockercfg_email" json:"dockercfg_email" yaml:"dockercfg_email,omitempty"`
